...
namespace Quizify.Api.DAL.EF.Migrations
{
    ...
    [Migration("20231027164906_EditedQuestionEntityAndQuizEntity")]
    partial class EditedQuestionEntityAndQuizEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizify.Api.DAL.EF.Entities.QuestionEntity", b =>
                {
                    b.HasOne("Quizify.Api.DAL.EF.Entities.QuizEntity", null)
                        ...
                        .HasForeignKey("Quizify.Api.DAL.EF.Entities.QuestionEntity", "Id");
